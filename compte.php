...
<div class="justify-content-md-center center">
  <div class="card col-6 mb-5" style="width: 50rem;">
    <div class="card-body">
      <h5 class="card-title center"> Compte : <?php echo htmlspecialchars($compte["name"]); ?></h5>
      <p class="card-text center">Numéro : <?php echo htmlspecialchars($compte["number"]); ?></p>
    </div>
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item">Derniére opération : <?php echo htmlspecialchars($compte["last_operation"]); ?></li>
    </ul>
    <div class="center">
